 ...
 * Edit this file to change the site's text — components never hardcode strings.
 */
...
export const profile = {
  ...
  x: "",
  /*
   * Cut-out portrait, generated from a studio photo by scripts/cutout.py.
   * Used in the hero. The bullet-time figure is the 3D model, not this.
   */
  portrait: "/me.png",
} as const;

/** Hero terminal — lines are typed out one after another. */
export const bootLines = [
  { text: "$ ssh sezeraric@matrix --identity=./portfolio", delay: 0 },
  { text: "Establishing connection ...", delay: 420 },
  { text: "Connection established.", delay: 380, tone: "ok" as const },
  { text: "", delay: 120 },
  { text: "Wake up, Furkan...", delay: 900, tone: "accent" as const },
  { text: "The codebase has you.", delay: 700, tone: "accent" as const },
  { text: "Follow the white rabbit.", delay: 700, tone: "accent" as const },
] as const;

/**
 * The bullet-time section. Each bullet is a real production problem.
 * The metaphor only works because these are things actually fought in the field.
 */
...
export const skills = [
  {
    group: "Frontend",
    items: [
      "React.js", "React Native (CLI & Expo)", "Vue.js", "TypeScript",
      "JavaScript", "Component Architecture", "Responsive Design",
    ],
  },
  {
  ...
  {
    group: "Backend",
    items: ["C#", ".NET / ASP.NET Core", "RESTful API", "Service & business logic"],
  },
  {
    group: "Data",
    items: ["MsSQL", "Redis", "Elasticsearch", "SQL / NoSQL query optimisation"],
  },
  {
    group: "Mobile",
    items: [
      "iOS / Android", "Push Notifications", "Maps", "In-App Purchase",
      "Firebase Auth / Firestore / FCM", "Reanimated", "Skia",
    ],
  },
  {
    group: "Tooling",
    items: ["GitHub", "Bitbucket", "Jira", "Postman", "Sentry", "Adjust", "CI/CD", "Unit Testing"],
  },
] as const;
...
/** The deep dive. Numbers here are measured from the repository, not estimated. */
export const caseStudy = {
  ...
  // TODO(sezer): drop screenshots into /public/mygarage/ and list them here
...
export const projects = {
  ...
  items: [
    {
      name: "SYNERGY-AI Cancer Trial Finder",
      blurb:
    ...
    },
    {
      ...
      tags: ["Platform", "API", "Admin"],
    },
    {
      name: "GFC Loyalty — Rewards",
      blurb:
    ...
    },
    {
      ...
      tags: ["Geo-fencing", "Social"],
    },
    {
      name: "Kampüs365 / iKampüs",
      blurb:
...
export const ai = {
  ...
  notes: [
    {
      title: "AI in the clinic, not the demo",
      body:
